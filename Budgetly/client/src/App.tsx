    ...
    return (
      <div className="hero">
        <div className="hero-content">
          <h1>Smart banking for<br />Ssmart people</h1>
      ...
      <div className="app-container">
        ...
        <nav className="navbar">
          ...
          <div className="nav-links">
            <button className="nav-link" onClick={handleBackToHome}>Back to Home</button>
          </div>
        </nav>
        {renderContent()}
      </div>
            ...
            <div className="modal-overlay">
              <div className="signup-modal">
                ...
                <div className="form-footer">
                  Already have an account? <button className="switch-form-btn" onClick={() => { setShowRegister(false); handleLogin(); }}>Login</button>
                </div>
              </div>
            </div>
          )}
